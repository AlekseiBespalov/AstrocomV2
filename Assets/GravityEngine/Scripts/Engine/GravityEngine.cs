...
#pragma warning restore 162       // re-enable unreachable code warning
	...
	/// body based on the gravitational force of all other bodies controlled by the engine. If the engine is evolving 
    /// the add is queued and run as part of the FixedUpdate loop. This protects in cases where the body add
    /// is occuring during a FixedBody update. 
	///
    ...
    /// marking the body inactive with InactivateGameObjectwill exclude it from physics calculations
...
#pragma warning disable 162        // disable unreachable code warning
	...
	private void UpdateGameObjects() {
		for (int i=0; i < worldState.numBodies; i++) {
            ...
            NBody nbody = gameNBodies[i].GetComponent<NBody>();
